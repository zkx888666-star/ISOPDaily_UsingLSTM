...
SAVE_DIR = r"E:\2026\Result0_ISOP\LSTM_Daily_Results_SEQ150HID64"
...
ROW_RANGE = [308, 313]   # 数组行索引范围 lat
COL_RANGE = [253, 258]   # 数组列索引范围
...
def load_nc_sliced(file_path, row_range, col_range):
    ...
    arr = da_slice.values.astype(np.float32).reshape(7*365, 5,5)
    ds.close()
